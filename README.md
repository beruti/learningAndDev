...
Inspired by this [Google Interview University study plan](https://github.com/jwasham/google-interview-university) and [a lot of awesome lists](https://github.com/sindresorhus/awesome), here's my own personal learnign plan.
...
The learning below is for general engineering related topics and is not designed to be language specific. Some parts are composed of pure learning material while others include some aspects that I will implement.
